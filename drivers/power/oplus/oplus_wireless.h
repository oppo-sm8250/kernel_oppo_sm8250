...
typedef enum{
    OPLUS_WPC_NO_CHARGER_MODE,
    OPLUS_WPC_NORMAL_MODE,
    OPLUS_WPC_FASTCHG_MODE,
    OPLUS_WPC_UNKNOW_MODE,
}E_WPC_CHG_MODE;

typedef enum{
	OPLUS_WPC_SWITCH_DEFAULT_MODE,
	OPLUS_WPC_SWITCH_WIRED_CHG_MODE,
	OPLUS_WPC_SWITCH_WPC_CHG_MODE,
	OPLUS_WPC_SWITCH_WIRED_OTG_MODE,
	OPLUS_WPC_SWITCH_WPC_OTG_MODE,
	OPLUS_WPC_SWITCH_OTHER_MODE,
};
...
struct oplus_wpc_chip {
    ...
    struct oplus_wpc_operations      *wpc_cp_ops;
...
struct oplus_wpc_operations {
    int (*init_irq_registers)(struct oplus_wpc_chip *chip);
    int (*get_vrect_iout)(struct oplus_wpc_chip *chip);
    int (*set_charger_type_dect)(struct oplus_wpc_chip *chip);
    int (*set_tx_charger_mode)(struct oplus_wpc_chip *chip);
    int (*set_voltage_out)(struct oplus_wpc_chip *chip);
    int (*set_dischg_enable)(struct oplus_wpc_chip *chip, bool is_on);
    void (*set_rx_charge_voltage)(struct oplus_wpc_chip *chip, int vol);
};
