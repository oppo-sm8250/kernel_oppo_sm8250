...
//------------------------------------------------------------------------------------------------
	...
	Sl_Hall_X_by_AF[ 0 ]	= 0xfffeb57e ;
	Sl_Hall_X_by_AF[ 1 ]	= 0xffff362b ;
	Sl_Hall_X_by_AF[ 2 ]	= 0x00031b00 ;
	Sl_Hall_X_by_AF[ 3 ]	= 0xfffd6a51 ;
	Sl_Hall_X_by_AF[ 4 ]	= 0xfffee5cb ;
	Sl_Hall_X_by_AF[ 5 ]	= 0x00064a8a ;
	Sl_Hall_X_by_AF[ 6 ]	= 0x0005ac5c ;
	Sl_Hall_X_by_AF[ 7 ]	= 0x00025bdd ;
	Sl_Hall_X_by_AF[ 8 ]	= 0x0008f0ff ;

	Sl_Hall_Y_by_AF[ 0 ]	= 0xfff2fa7b ;
	Sl_Hall_Y_by_AF[ 1 ]	= 0xffeced77 ;
	Sl_Hall_Y_by_AF[ 2 ]	= 0xffe8b9fa ;
	Sl_Hall_Y_by_AF[ 3 ]	= 0xffe68104 ;
	Sl_Hall_Y_by_AF[ 4 ]	= 0xffe432fb ;
	Sl_Hall_Y_by_AF[ 5 ]	= 0xffde2a66 ;
	Sl_Hall_Y_by_AF[ 6 ]	= 0xffe14cec ;
	Sl_Hall_Y_by_AF[ 7 ]	= 0xffde775f ;
	Sl_Hall_Y_by_AF[ 8 ]	= 0xffdedd32 ;
#endif

//------------------------------------------------------------------------------------------------
// Send the calibration data
//------------------------------------------------------------------------------------------------
	RamWrite32A( OIS_POS_BY_AF_X1, Sl_Hall_X_by_AF[ 0 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_X2, Sl_Hall_X_by_AF[ 1 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_X3, Sl_Hall_X_by_AF[ 2 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_X4, Sl_Hall_X_by_AF[ 3 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_X5, Sl_Hall_X_by_AF[ 4 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_X6, Sl_Hall_X_by_AF[ 5 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_X7, Sl_Hall_X_by_AF[ 6 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_X8, Sl_Hall_X_by_AF[ 7 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_X9, Sl_Hall_X_by_AF[ 8 ] ) ;

	RamWrite32A( OIS_POS_BY_AF_Y1, Sl_Hall_Y_by_AF[ 0 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_Y2, Sl_Hall_Y_by_AF[ 1 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_Y3, Sl_Hall_Y_by_AF[ 2 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_Y4, Sl_Hall_Y_by_AF[ 3 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_Y5, Sl_Hall_Y_by_AF[ 4 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_Y6, Sl_Hall_Y_by_AF[ 5 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_Y7, Sl_Hall_Y_by_AF[ 6 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_Y8, Sl_Hall_Y_by_AF[ 7 ] ) ;
	RamWrite32A( OIS_POS_BY_AF_Y9, Sl_Hall_Y_by_AF[ 8 ] ) ;

	RamWrite32A( CMD_OIS_SHIFT_CAL, 0 ) ;
