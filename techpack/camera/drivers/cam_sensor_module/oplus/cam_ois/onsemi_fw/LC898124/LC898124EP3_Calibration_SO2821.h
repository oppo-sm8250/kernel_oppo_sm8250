...
#define		XY_OFST			(0x10000000 )
 ...
 #define	SINE_GAIN		(0x7FFFFFFF	)	/*üÍSinegĚĹĺdŹ*/
#else	//HALLADJ_FULLCURRENT
 #define 	MARGIN			(0x1000		)	// VDD-Margin,GND-MARGIN
 #define 	BIAS_RANGE_XY	(0x8CCC		)	// 55%
 #define	SINE_OFFSET		(0x00074528 )	/* Freq * 80000000h / 18.0288kHz   : 4Hz */ 
 #define	SINE_GAIN		(0x4D780000	)	/*üÍSinegĚĹĺdŹ 115mA (115mA*7fff/190mA)  190mA(min) */
 ...
 #define	SINE_GAIN_F		(0x7FFFFFFF	)	/*üÍSinegĚĹĺdŹ*/
#endif
