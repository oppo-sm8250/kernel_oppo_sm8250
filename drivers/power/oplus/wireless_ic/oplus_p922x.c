...
int oplus_wpc_chg_parse_chg_dt(struct oplus_p922x_ic *chip)
{
	int rc;
...
bool oplus_wpc_get_epp_chg_allow(struct oplus_p922x_ic *chip)
{
	int temp = 0;

	temp = oplus_chg_get_chg_temperature();

	if(chip->p922x_chg_status.adapter_type != ADAPTER_TYPE_EPP){
		chip->p922x_chg_status.epp_chg_allow = false;
		return chip->p922x_chg_status.epp_chg_allow;
	}
	...
	chip->p922x_chg_status.epp_chg_allow = true;
	return chip->p922x_chg_status.epp_chg_allow;
}

bool oplus_wpc_get_fastchg_allow(struct oplus_p922x_ic *chip)
{
	int temp = 0;
	int cap = 0;
...
int oplus_wpc_set_input_current(struct oplus_p922x_ic *chip)
{
	int current_limit = 0;
